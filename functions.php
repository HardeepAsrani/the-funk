...
if ( ! function_exists( '_wp_render_title_tag' ) ) {
	function thefunk_render_title() {
?>
<title><?php wp_title( '|', true, 'right' ); ?></title>
<?php
	}
	add_action( 'wp_head', 'thefunk_render_title' );
}
...
function thefunk_customizer_header()
{
    ...
    $header_color             = $thememod['header_color'];
    $site_title_color         = $thememod['site_title_color'];
    $site_title_color_hover   = $thememod['site_title_color_hover'];
    $site_description_color   = $thememod['site_description_color'];
    $primary_site_color       = $thememod['primary_site_color'];
    $primary_color_hover      = $thememod['primary_color_hover'];
    $post_meta_color          = $thememod['post_meta_color'];
    $headnav_color            = $thememod['headnav_color'];
    $headnav_color_hover      = $thememod['headnav_color_hover'];
    $primarynav_color         = $thememod['primarynav_color'];
    $primarynav_color_hover   = $thememod['primarynav_color_hover'];
    $primarynav_color_active  = $thememod['primarynav_color_active'];
    $footer_background        = $thememod['footer_background'];
    $footer_color             = $thememod['footer_color'];
    $footer_title             = $thememod['footer_title'];
    $footer_link              = $thememod['footer_link'];
    $footer_link_hover        = $thememod['footer_link_hover'];
